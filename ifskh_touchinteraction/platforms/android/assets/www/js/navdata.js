...
.factory('NavDataService', function ($q, $timeout) {
    var cities = ["Aachen", "Amberg", "Berlin", "Cottbus", "Dachau", "Duesseldorf",
                    "Erfurt", "Frankfurt", "Freiburg", "Kelheim", "Leibzig", "Muenchen",
                    "Nuernberg", "Oldenburg", "Passau", "Ravensburg", "Remstadt", "Regensburg",
                    "Saal a. d. Donau", "Schweinfurt", "Schwerin", "Wuerzburg", "Zwickau"];
    ...
    return { searchCities: searchCities }
});
